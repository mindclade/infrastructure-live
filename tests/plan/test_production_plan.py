...
class ProductionPlanTest(unittest.TestCase):
    def test_delete_and_replace_return_destructive_status(self):
        document = {
            ...
            "resource_changes": [
                {
                    "address": "google_sql_database_instance.production",
                    "change": {"actions": ["delete"]},
                },
                {
                    "address": "google_container_cluster.production",
    ...
    def test_digest_ignores_only_timestamp_and_json_serialization(self):
        ...
        document["planned_values"]["root_module"]["resources"][0]["values"]["name"] = (
            "changed-project"
        )
