        ...
        result = classify(
            {
                ...
                "resource_changes": [
                    {
                        "address": "google_project.development",
                        "change": {"actions": ["create"], "after": {"sensitive": "must-not-print"}},
                    },
                    {
                        "address": "google_compute_network.development",
                        "change": {"actions": ["update"], "after": {"name": "logical-network"}},
                    },
                ],
            }
        )
